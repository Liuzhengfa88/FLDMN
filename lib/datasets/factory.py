...
for year in ["2007", "2012"]:
    for split in ["train", "val", "trainval", "test", "train_s", "train_ft"]:
...
for year in ["2007", "2012"]:
    for split in ["train_s", "train_t","train_fs", "train_ft", "train_all", "test_s", "test_t", "test_all"]:
...
for year in ["2007"]:
    for split in ["trainval", "train", "test", "train_t", "train_fs", "test_t"]:
