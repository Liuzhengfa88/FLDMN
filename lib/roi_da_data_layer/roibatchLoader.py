...
class roibatchLoader(data.Dataset):
    ...
    def __getitem__(self, index):  # only one sample
        ...
        def img_process(index_ratio, roidb):
            ...
            """
                ...
                if roidb[index_ratio]["need_crop"]:
                    if ratio < 1:
        ...
        org_data = img_process(index_ratio, self._roidb)
        syn_data = img_process(index_ratio, self._f_roidb)

        return  org_data, syn_data
